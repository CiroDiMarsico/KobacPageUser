...
const createManual = async (req, res) => {
    try {
        const { clientName, clientPhone, location, rubro, items, payments, shippingPrice, discountAmount } = req.body
        ...
        const id = await adminSalesModel.createManual({ clientName, clientPhone, location, rubro, items, payments, shippingPrice, discountAmount })
